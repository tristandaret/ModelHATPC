...
def Charge0D(t, x0, y0, xmin, xmax, ymin, ymax, RC, z):  # fC
    """Compute the integrated charge (fC) collected by a cell for a point deposit.
...
def Charge1D(t, m, q, xmin, xmax, ymin, ymax, RC, z, Dt=Dt):  # fC
    """Compute the integrated charge (fC) collected by a cell for a lineic deposit.
...
def Signal0D(t, x0, y0, xmin, xmax, ymin, ymax, RC, z):
    """Compute the shaped signal for a point deposit by convolving charge with ETF'."""
    return (
        np.convolve(
...
def Signal1D(t, m, q, xmin, xmax, ymin, ymax, RC, z, Dt=Dt):
    """Compute the shaped signal for a line deposit by convolving charge with ETF'."""
    return (
        np.convolve(
...
def Signal1DFFT(t, m, q, xmin, xmax, ymin, ymax, RC, z):
    """Compute an FFT-based convolution variant of Signal1D.
